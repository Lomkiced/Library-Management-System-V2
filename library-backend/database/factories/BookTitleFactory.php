...
class BookTitleFactory extends Factory
{
    ...
    public function definition()
    {
        return [
            ...
            'category' => $this->faker->randomElement(['Article', 'Book', 'Computer File/Electronic Resources', 'Map', 'Thesis', 'Visual Materials']),
            'college' => $this->faker->randomElement(['GENERAL', 'COLLEGE OF CRIMINOLOGY', 'COLLEGE OF MARITIME', 'COLLEGE OF INFORMATION TECHNOLOGY', 'COLLEGE OF HOSPITALITY & TOURISM MANAGEMENT', 'COLLEGE OF BUSINESS ADMINISTRATION', 'COLLEGE OF EDUCATION']),
